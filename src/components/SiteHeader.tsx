    ...
    <>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 h-14 sm:h-16 flex items-center justify-between gap-3">
        ...
        <nav className="flex items-center gap-1 sm:gap-2 flex-shrink-0" aria-label="주요 메뉴">
          ...
          {/* 관리자 진입 — 작은 톱니바퀴 아이콘. 운영자만 알고 있는 경로. */}
          <Link
            href="/admin/materials"
            aria-label="관리자"
            title="관리자"
            className="ml-1 inline-flex items-center justify-center w-7 h-7 rounded-md text-zinc-300 hover:text-zinc-700 hover:bg-zinc-100 transition"
          >
